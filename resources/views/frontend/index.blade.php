      ...
      <div class="block-30 block-30-compact item" style="background-image: url('images/bg_1.jpg');" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-9">
              <h1 class="heading mb-4" style="font-family:Rockwell;font-weight: bold;">Si NggoRat</h1>
              ...
              <p class="mb-0">
                ...
                <a href="{{route('frontend.reports.index')}}" id="start" class="btn btn-lg btn-theme px-3 py-2 mx-2">Karya Siswa<i class="fas fa-arrow-right"></i></a>
              </p>
  ...
  <div class="site-section section-counter">
    <div class="container">
      <div class="row" id="get-started">
        ...
        <div class="col-md-6">
            <img src="images/girl-writing.webp" alt="Girl Writing" style="width: 100%;" />
        </div>
      </div>
    </div>
  </div>

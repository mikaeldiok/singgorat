        ...
        <div class="row">
            ...
            <div class="col-6 col-sm-4">
                <div class="float-right">
                    <x-buttons.create route='{{ route("backend.$module_name.createGuru") }}' title="{{__('Create')}} {{ ucwords(Str::singular($module_name)) }}"/>
...
<script type="text/javascript">
    ...
    $('#datatable').DataTable({
        ...
        autoWidth: true,
        responsive: true,
        ajax: '{{ route("backend.$module_name.index_data_guru") }}',
        columns: [
            {data: 'id', name: 'id'},
            {data: 'name', name: 'name'},

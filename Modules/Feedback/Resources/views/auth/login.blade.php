            ...
            <div class="col-lg-6 col-md-8">
                <div class="card bg-light border border-soft">
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        <form role="form" method="POST" action="{{ route('auth.remarks.login') }}">
                            @csrf
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-merge input-group-alternative mb-3">
                                    ...
                                    <input type="email" class="form-control" id="remark_email" name="remark_email" value="{{ old('remark_email') }}" placeholder="{{ __('E-Mail Address') }}" aria-label="email" aria-describedby="input-email" required>
                                </div>
                            </div>
                            <div class="form-group">
